window.onload = function () {
        ...
        var chart = new CanvasJS.Chart("chartContainer", {
            ...
            zoomEnabled: true,
            title: {
                text: "Number of language learned"
            },
            data: [{
                type: "area",
                dataPoints: []
    ...
    const chart2 = new CanvasJS.Chart("chartContainer2", {
        ...
        data: [{
            ...
            indexLabel: "{y}",
            dataPoints: [
                {label: "United States", y: 12},
                {label: "United Kingdom", y: 10},
                {label: "Phillippines", y: 9},
                {label: "Thailand", y: 5}
            ]
        }]
    });
